...
const int PIN_IN1 = 8;  // 방향 제어 핀
const int PIN_IN2 = 9;  // 방향 제어 핀

const int PWM_STEP = 10; // 한 번 누를 때 변할 수치
...
void setup() {
  ...
  Serial.begin(9600);
  Serial.println("=== 펠티어 제어 테스트 준비 완료 ===");
  Serial.println("키보드 입력: 1(감소), 2(증가), 3(방향전환)");
